    ...
    if selected_mode == "company":
        for report in preflight_statement_files(statements):
            statement_reports[report.source_file.name] = {
                ...
                "column_mapping": dict(report.column_mapping),
                "column_labels": dict(report.column_labels),
                "mapping_options": list(report.mapping_options),
                "mapping_required": report.mapping_required,
                "sign_convention": report.sign_convention,
                "sign_convention_required": report.sign_convention_required,
                "profile_reused": report.profile_reused,
